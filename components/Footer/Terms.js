export default function Terms() {
  return (
    <div className="terms-wrap">
      <h2 className="delivery-text">Terms Of Service</h2>

      <h4 className="delivery-text">Overview</h4>
      ...
      <p className="delivery-text">
        ...
        before acccessing or using our website. By accessing or using any part
        of this site, you agree to be bound by these Terms of Service . If you
      ...
      <p className="delivery-text">
        ...
        your region of residence and you have given us your consent to allow any
        of your minor dependents to use this site. You may not use our products
        for any illegal or unauthourised purpose nor may you, in the use of the
      ...
      <p className="delivery-text">
        ...
        Credit card information is always encrypeted during transfer over
        ...
        Service or any contact on the website trough which the service is
      ...
      <p className="delivery-text">
        ...
        reliance on the material on this site at your own risk. This site may
        contain historical information. Historical information, necessarily, is
        not current and is provided for your reference only. We reserve the
        righht to modify the contents of this site at any time, but we have no
      ...
      <p className="delivery-text">
        ...
        service made on this site is void where prohibted. we do not warrant
      ...
      <p className="delivery-text">
        ...
        that use the same billing/shipping address. In the event that we make a
        change to cancel an order, we may attempt to notify you by contacting
        ...
        in our sole judgement, appear to be placed by dealers, resellers or
      ...
      <p className="delivery-text">
        ...
        that are not affilliated with us. We are not responsible for examining
        ...
        websites, or for any other aterials, products,or service of
