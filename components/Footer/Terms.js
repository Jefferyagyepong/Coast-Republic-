  ...
  return (
    <div className="ibrid-box-line-law">
      ...
      <article>
        <section>
          <p>
            Coast Republic offers this website, including all information, tools
            ...
            and policies referenced here in and/ or available by hyperlink.
          </p>
        </section>
      </article>
      <br />
      ...
      <article>
        <section>
          <p>
            ...
            Service carefully before acccessing or using our website. By
            accessing or using any part of this site, you agree to be bound by
            these Terms of Service . If you do not agree to all of the terms and
      ...
      <article>
        <section>
          <p>
            If these Terms of Service are considered an offer, accounts is
            expressly limited to these Terms od Service. Any new features or
            tools whhich are added to the current store shall also be subject to
            the Terms and Service. You can review the current version of the
            ...
            responsibilty to check this page periodically for changes. Your
            ...
            hosted on vercel. They provide us with hosting platform that allows
      ...
      <article>
        <section>
          <p>
            SECTION 1 - ONLINE STORE TERMS By agreeing to these Terms of
            Service,you represent that you are at least the age of majority in
            your region or state/province of residence, or that your are the age
            of majority in your region of residence and you have given us your
            consent to allow any of your minor dependents to use this site. You
            may not use our products for any illegal or unauthourised purpose
            ...
            immediate termination of your service.
          </p>
        </section>
      </article>
      <br />
      ...
      <article>
        <section>
          <p>
            ...
            to anyone for any reason at any time. You understand that your
            content (not legit credit card information), may be transmit
            uncrypted and involve (a) transmissions over various networks: and
            ...
            encrypeted during transfer over networks. You agree not to reproduce
            ...
            website trough which the service is provided, without express
            written permission by us. The headings used in this agreement are
            included for convinience only and will not limit or otherwise affect
            these Terms.
          </p>
        </section>
      </article>
      ...
      <article>
        <section>
          <p>
            ...
            are not responsible if information made available on this site is
            ...
            information. Any reliance on the material on this site at your own
            risk. This site may contain historical information. Historical
            information, necessarily, is not current and is provided for your
            reference only. We reserve the righht to modify the contents of this
            site at any time, but we have no obligation to update any
            information on our site. You agree that it is your responsibilty to
      ...
      <article>
        <section>
          <p>
            ...
            products are subject to change without notice. We reserve the right
            at any time to modify or discontinue te Service(or any part or
            content thereof) without notice at any time. We shall not be liable
      ...
      <article>
        <section>
          <p>
            ...
            subject to return or exchange only according to the Return Policy.
            we have made every effort to disolay as accurately as possible the
            color and images of our products that appear at the store. We cannot
            guarantee that your computer&apos;s monitor&apos; display of any
            ...
            any product at any time. Any offer for a product or service made on
            this site is void where prohibted. we do not warrant that the
      ...
      <article>
        <section>
          <p>
            ...
            orders that use the same billing/shipping address. In the event that
            we make a change to cancel an order, we may attempt to notify you by
      ...
      <article>
        <section>
          <p>
            SECTION 7- OPTIOPNAL TOOLS we may provide you with access to
            third-party tools over which we neither onitor nor have any control
            ...
            endorsement. We shall have no liability whatsever arising fro
            ...
            risk and discretion and you should ensure that you are familair with
            ...
            and/or features through website (including, the release of new tools
      ...
      <article>
        <section>
          <p>
            ...
            websites that are not affilliated with us. We are not responsible
            ...
            third-party materials or websites, or for any other aterials,
            products,or service of third-parties. We are not liable for any harm
            ...
            third-party&apos;s policies and practices and ake sure you
            understand the before you engage in any transaction. Complaints,
      ...
      <article>
        <section>
          <p>
            ...
            suggestions, proposals, plans other materials, whether online, by
            ...
            otherwise use in any nediumm any coents that you forward to us. We
            are and shall be under no obligation (1) to maintain any coents in
            confidence; (2) to pay compensation for any comments; or (3) to
            respond to any comments. We may have no obligation to, monitor, edit
            or remove content that we determine in our sole discretion are
            unlawful, offensive, threatning, libelous, defamatory, pornographic,
            obscene or otherwise objectionable or violates any party&apos;s
            intellectual property or these Termms of Service. You agree that
            your comments will notviolate any right of any third-party,
            ...
            or other maleware that could in any way affect the operation of the
            ...
            solely responsible for any commments you make and their accuracy. We
            take no responsibility and assumme no liabilty for any commments
      ...
      <article>
        <section>
          <p>
            ...
            set forth in the Terms of Service, you are prohibited from using the
            site or its content: (a) for any unlawful purpose; (b) to solicit
            ...
            rules, laws, or local ordinances; (d) to infringe upon or violate
            our intellectual property rights or the intellectual property rights
      ...
      <article>
        <section>
          <p>
            ...
            not guarantee, represent or warrant that your use of our service
            ...
            case shall KRUDE, our directors, officers, employees, affiliates,
      ...
      <article>
        <section>
          <p>
            ...
            harmless COAST REPUBLIC and our parent, subsidiaries, affiliates,
      ...
      <article>
        <section>
          <p>
            ...
            Service should be sent to us at support@coastrepublic.com
          </p>
        </section>
      </article>
      <br />
