  ...
  return (
    <div className="ibrid-box">
      ...
      <p className="delivery-text">
        ...
        using cookies, log files, web beacons, tags, or pixels. Disclosure for a
        business purpose: shared with our processor Shopify Personal Information
        collected: version of web browser, IP address, time zone, cookie
        information, what sites or products you view, search terms, and how you
      ...
      <p className="delivery-text">
        ...
        our customers use the Site. You can read more about how Google uses your
      ...
      <p className="delivery-text">
        ...
        of the Site, your purchases, and the email address associated with your
        purchase instructions on how to opt-out of sale; whether your business
        sells information of minors (under 16) and whether you obtain
      ...
      <p className="delivery-text">
        ...
        the contact information above. [OR INSERT ALTERNATIVE INSTRUCTIONS FOR
        SENDING ACCESS, ERASURE, CORRECTION, AND PORTABILITY REQUESTS] Your
        Personal Information will be initially processed in Ireland and then
        will be transferred outside of Europe for storage and further
        ...
        GDPR Whitepaper:
        https://help.shopify.com/en/manual/your-account/privacy/GDPR. CCPA If
        you are a resident of California, you have the right to access the
