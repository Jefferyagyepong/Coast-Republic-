    ...
    <div className="ibrid-box-line-law">
      <article>
        <section>
          ...
          <br />
          <p>
            This Privacy Policy describes how coast republic (the “Site” or
      ...
      <article>
        <section>
          ...
          <p>
            Device information Purpose of collection: to load the Site
            accurately for you, and to perform analytics on Site usage to
            optimize our Site. Source of collection: Collected automatically
            when you access our Site using cookies, log files, web beacons,
            tags, or pixels. Disclosure for a business purpose: shared with our
            processor Shopify Personal Information collected: version of web
          ...
          <p>
            Order information Purpose of collection: to provide products or
            ...
            relating to our products or services. Source of collection:
            collected from you. Disclosure for a business purpose: shared with
            our processor Paystack. Personal Information collected: name,
            billing address, shipping address, payment information (including
            credit card numbers), email address, and phone number.
          </p>

          <p>
            Customer support information Purpose of collection: to provide
            customer support. Source of collection: collected from you
            Disclosure for a business purpose: Personal Information collected:
            collected from you
          </p>
        </section>
      </article>
      ...
      <article>
        <section>
          ...
          <p>
            ...
            described above. For example: We use Google Analytics to help us
            ...
            https://tools.google.com/dlpage/gaoptout. We share information about
            your use of the Site, your purchases, and your interaction with our
            ads on other websites with our advertising partners. We collect and
            share some of this information directly with our advertising
            ...
            location). We use Shopify Audiences to help us show ads on other
            websites with our advertising partners to buyers who made purchases
            with other Shopify merchants and who may also be interested in what
            we have to offer. We also share information about your use of the
            ...
            merchants may make offers you may be interested in. For more
      ...
      <article>
        <section>
          ...
          <p>
            ...
            on new products, services, and offers. Lawful basis Pursuant to the
            General Data Protection Regulation (“GDPR”), if you are a resident
            of the European Economic Area (“EEA”), we process your personal
            information under the following lawful bases: Your consent; The
            performance of the contract between you and the Site; Compliance
            with our legal obligations; To protect your vital interests; To
            perform a task carried out in the public interest; For our
            legitimate interests, which do not override your fundamental rights
            and freedoms.
          </p>
        </section>
      </article>
      ...
      <article>
        <section>
          ...
          <p>
            ...
            otherwise significantly affects you.We DO engage in fully automated
            decision-making that has a legal or otherwise significant effect
            using customer data. Our processor Shopify uses limited automated
            decision-making to prevent fraud that does not have a legal or
            otherwise significant effect on you. Services that include elements
            of automated decision-making include: Temporary blacklist of IP
            addresses associated with repeated failed transactions. This
            blacklist persists for a small number of hours. Temporary blacklist
            of credit cards associated with blacklisted IP addresses. This
      ...
      <article>
        <section>
          ...
          <p>
            ...
            information sold; IF USING SHOPIFY AUDIENCES: information about your
            use of the Site, your purchases, and the email address associated
            with your purchase instructions on how to opt-out of sale; whether
            your business sells information of minors (under 16) and whether you
            obtain affirmative authorization; if you provide a financial
            incentive to sell information, provide information about what that
            incentive is.]
          </p>
        </section>
      </article>
      ...
      <article>
        <section>
          ...
          <p>
            GDPR If you are a resident of the EEA, you have the right to access
            ...
            please contact us through the contact information above. [OR INSERT
            ALTERNATIVE INSTRUCTIONS FOR SENDING ACCESS, ERASURE, CORRECTION,
            AND PORTABILITY REQUESTS] Your Personal Information will be
            initially processed in Ireland and then will be transferred outside
            of Europe for storage and further processing, including to Canada
            and the United States. For more information on how data transfers
            comply with the GDPR, see Shopify’s GDPR Whitepaper:
            https://help.shopify.com/en/manual/your-account/privacy/GDPR. CCPA
            ...
            information above. If you would like to designate an authorized
            agent to submit these requests on your behalf, please contact us at
            the address above.
          </p>
        </section>
      </article>
