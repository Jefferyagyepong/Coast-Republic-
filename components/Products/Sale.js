...
<div className="slides slowFade">
        ...
        <div className="slide">
          ...
          <div className="slide">
            <Image  alt=""src={"https://images.unsplash.com/photo-1704949841973-9db544ac35ec?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}/>
            </div>
              <div className="slide">
             <h2>New Season</h2>
