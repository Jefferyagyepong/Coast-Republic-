...
const ImageCarousel = ({ images }) => {
  ...
  const defaultImages = images || [
    { src: '/gyamfua black OLIVE.svg', name: 'Sunset Beach' },
    { src: '/airjordan.svg', name: 'Mountain Peak' },
    { src: '/wrangler.svg', name: 'City Skyline' },
    { src: '/products/force1b.JPG', name: 'Forest Path' },
  ];
