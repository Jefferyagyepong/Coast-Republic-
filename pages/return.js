  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Read our return policy before making a purchase." />
      </Head>
      <div className="container">
        ...
        <h2>Refunds</h2>
        <p>
          Once we receive your return, we will inspect it and notify you of the status. If approved, your refund will be processed
